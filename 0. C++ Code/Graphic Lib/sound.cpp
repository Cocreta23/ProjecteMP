...
struct T_SOUND *Sound_LoadFileStream(const char *path, int bLoop)
{
...
struct T_SOUND *Sound_LoadMemoryStream(const char *path, int bLoop)
{
  struct T_SOUND *new_sound ;
  int tam_buffer ;
  int error ;
...
struct T_SOUND *Sound_LoadMusic(const char *path, int bStream)
{
...
struct T_SOUND *Sound_LoadSound(const char *path)
{
