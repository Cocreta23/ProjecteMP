...
{
    GRAFIC_FONS = 0,
    GRAFIC_POSICIO_VALIDA_1,
    GRAFIC_POSICIO_VALIDA_2,
    GRAFIC_POSICIO_VALIDA_3,
    GRAFIC_POSICIO_VALIDA_4,
    GRAFIC_POSICIO_VALIDA_5,
    GRAFIC_POSICIO_VALIDA_6,
    GRAFIC_POSICIO_VALIDA_7,
    GRAFIC_TAULER,
    GRAFIC_DOUBLE_TAKEDOWN,
    GRAFIC_FITXA_BLANCA,
    GRAFIC_FINAL,
    GRAFIC_DAMA_BLANCA,
    GRAFIC_FITXA_NEGRA,
