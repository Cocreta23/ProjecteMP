...
string GraphicManager::getImagePath(IMAGE_NAME name){
    ...
    switch (name) {
        ...
        case GRAFIC_TAULER:
            ...
            break;
		case GRAFIC_POSICIO_VALIDA_1:
			path = "data/GUI/posicio_valida_1.png";
			break;
        case GRAFIC_POSICIO_VALIDA_2:
            path = "data/GUI/posicio_valida_2.png";
            break;
        case GRAFIC_POSICIO_VALIDA_3:
            path = "data/GUI/posicio_valida_3.png";
            break;
        case GRAFIC_POSICIO_VALIDA_4:
            path = "data/GUI/posicio_valida_4.png";
            break;
        case GRAFIC_POSICIO_VALIDA_5:
            path = "data/GUI/posicio_valida_5.png";
            break;
        case GRAFIC_POSICIO_VALIDA_6:
            path = "data/GUI/posicio_valida_6.png";
            break;
        case GRAFIC_POSICIO_VALIDA_7:
            path = "data/GUI/posicio_valida_7.png";
            break;
        case GRAFIC_DOUBLE_TAKEDOWN:
            path = "data/imatge.png";
            break;
